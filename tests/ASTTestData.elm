...
inlineBasicAST =  "Root (0) Paragraph [  Line [Text [DOCUMENT]]]\n  Blank (1)   Paragraph [  Line [Text [This ] Italic [is] Text [a test.]]\n    Line [Text [I ] Bold [repeat] Text [: a test.]]\n    Line [StrikeThroughText [Wrong! ]]]\n  Plain (1)   Paragraph [  Line [Text [This is code: ] Code [a := b`]]\n    Line [Text [This is math: ] InlineMath [a^2 + b^2 = c^2]]]\n  Blank (1)   Paragraph [  Line [Text [Link: ] Link [http://nytimes.com](New York Times) Text [Image: !] Link [https://www.allaboutbirds.org/guide/noindex/photo/60395551-1280px.jpg](Hummingbird)]]\n  Blank (1)   Paragraph [  Line []]"
