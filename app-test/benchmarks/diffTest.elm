...
treeA1 = ParseWithId.toMDBlockTree 1 ExtendedMath textA1

treeA2 = ParseWithId.toMDBlockTree 2 ExtendedMath textA2

treeB1 = ParseWithId.toMDBlockTree 1 ExtendedMath textB1

treeB2 = ParseWithId.toMDBlockTree 2 ExtendedMath textB2
...
suite =
    describe "Diff"
        ...
        [  benchmark "texts A" <|
            \_ -> Diff.mergeWith ParseWithId.equal treeA1 treeA2

         , benchmark "texts B (two copies of A)" <|
                       \_ -> Diff.mergeWith ParseWithId.equal treeB1 treeB2
