...
var $author$project$Demo$download = function (latexContent) {
...
var $author$project$Markdown$Paragraphs$ChompUntilTwoNewLines = {$: 'ChompUntilTwoNewLines'};
	...
	A2(
		...
		$elm$parser$Parser$Advanced$getChompedString(
			$elm$parser$Parser$Advanced$chompUntil(
				A2($elm$parser$Parser$Advanced$Token, '\n\n', $author$project$Markdown$Paragraphs$ChompUntilTwoNewLines))),
...
var $author$project$Markdown$LaTeXPostProcess$InRunningText = {$: 'InRunningText'};
...
var $author$project$Markdown$LaTeXPostProcess$BeginItemList = {$: 'BeginItemList'};
var $author$project$Markdown$LaTeXPostProcess$Done = function (a) {
	return {$: 'Done', a: a};
};
var $author$project$Markdown$LaTeXPostProcess$EndItemList = {$: 'EndItemList'};
var $author$project$Markdown$LaTeXPostProcess$InItemList = {$: 'InItemList'};
...
var $author$project$Markdown$LaTeXPostProcess$ItemParagraph = {$: 'ItemParagraph'};
var $author$project$Markdown$LaTeXPostProcess$NormalParagraph = {$: 'NormalParagraph'};
...
var $author$project$Markdown$LaTeXPostProcess$paragraphType = function (str) {
	...
	if (_v0.$ === 'Ok') {
		return $author$project$Markdown$LaTeXPostProcess$ItemParagraph;
	} else {
		return $author$project$Markdown$LaTeXPostProcess$NormalParagraph;
	}
};
var $author$project$Markdown$LaTeXPostProcess$nextMachineState = function (ms) {
	...
	if (_v0.$ === 'Nothing') {
		...
		if (_v1.$ === 'InRunningText') {
			return $author$project$Markdown$LaTeXPostProcess$Done(ms.items);
		} else {
			return $author$project$Markdown$LaTeXPostProcess$Done(
				A2($elm$core$List$cons, $author$project$Markdown$LaTeXPostProcess$EndItemList, ms.items));
		}
	} else {
		var str = _v0.a;
					...
					_Utils_update(
						ms,
						{
							items: A2(
								...
								A2($elm$core$List$cons, $author$project$Markdown$LaTeXPostProcess$EndItemList, ms.items)),
							paragraphs: A2($elm$core$List$drop, 1, ms.paragraphs),
							register: $author$project$Markdown$LaTeXPostProcess$InRunningText
						}));
			}
		} else {
			if (_v2.b.$ === 'InRunningText') {
					...
					_Utils_update(
						ms,
						{
							items: A2(
								$elm$core$List$cons,
								$author$project$Markdown$LaTeXPostProcess$S(str),
								A2($elm$core$List$cons, $author$project$Markdown$LaTeXPostProcess$BeginItemList, ms.items)),
							paragraphs: A2($elm$core$List$drop, 1, ms.paragraphs),
							register: $author$project$Markdown$LaTeXPostProcess$InItemList
						}));
			} else {
				var _v9 = _v2.a;
				var _v10 = _v2.b;
...
var $author$project$Markdown$LaTeXPostProcess$machine = function (stringList) {
	var initialState = {items: _List_Nil, paragraphs: stringList, register: $author$project$Markdown$LaTeXPostProcess$InRunningText};
...
var $author$project$Markdown$LaTeX$export = function (str) {
	return A2(
		...
		_Utils_Tuple2(0, 0),
		A3($author$project$Markdown$Parse$toMDBlockTree, 0, $author$project$Markdown$Option$ExtendedMath, str));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'MarkdownMsg':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				var laTeXContent = $author$project$Markdown$LaTeX$export(model.sourceText);
				return _Utils_Tuple2(
					model,
					$author$project$Demo$download(laTeXContent));
		}
	});
...
var $author$project$Demo$ExportToLaTeX = {$: 'ExportToLaTeX'};
var $author$project$Demo$exportToLaTeXButton = function (width) {
	return A2(
		$elm$html$Html$button,
		_Utils_ap(
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$Demo$ExportToLaTeX)
				]),
			A2($author$project$Style$buttonStyle, $author$project$Style$colorBlue, width)),
		_List_fromArray(
			[
	...
	function (selectedId, id, level, items) {
		var folder = F2(
			function (item, _v8) {
				...
				if (item.$ === 'OrdinaryText') {
					var str = item.a;
					var _v7 = $author$project$Markdown$Render$isPunctuation(
						A2($elm$core$String$left, 1, str));
					if (_v7) {
						return _Utils_Tuple2(
							A2($elm$core$List$cons, str, accString),
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Demo$exportToLaTeXButton(100),
						A2(
						$elm$html$Html$span,
						_List_fromArray(
							[
...
_Platform_export({'Demo':{'init':$author$project$Demo$main(
	$elm$json$Json$Decode$succeed(
		{}))({"versions":{"elm":"0.19.1"},"types":{"message":"Demo.Msg","aliases":{},"unions":{"Demo.Msg":{"args":[],"tags":{"Clear":[],"GetContent":["String.String"],"GenerateSeed":[],"NewSeed":["Basics.Int"],"RestoreText":[],"RefreshText":[],"SelectStandard":[],"SelectExtended":[],"SelectExtendedMath":[],"MarkdownMsg":["Markdown.Render.MarkdownMsg"],"ExportToLaTeX":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Markdown.Render.MarkdownMsg":{"args":[],"tags":{"IDClicked":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));