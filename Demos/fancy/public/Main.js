...
var $author$project$Markdown$Render$fromASTWithOptions = F3(
	function (outputOption, selectedId, ast) {
		switch (outputOption.$) {
			case 'Basic':
	...
	A2(
		...
		$elm$parser$Parser$Advanced$symbol(
			A2(
				$elm$parser$Parser$Advanced$Token,
				'@',
				$author$project$MDInline$Expecting('Expecting \'@\' to begin tail of email address')))),
	A2(
		$elm$parser$Parser$Advanced$ignorer,
	...
	return $elm$parser$Parser$Advanced$getChompedString(
		$elm$parser$Parser$Advanced$chompUntil(
			A2(
				...
				$author$project$MDInline$Expecting('Expecting \'' + (end + '\' in parseUntil')))));
};
		...
		A2(
			...
			$elm$parser$Parser$Advanced$symbol(
				A2(
					$elm$parser$Parser$Advanced$Token,
					'@',
					$author$project$MDInline$Expecting('Expecting \'@\' to begin extension element')))),
		A2(
			$elm$parser$Parser$Advanced$ignorer,
			...
			$elm$parser$Parser$Advanced$symbol(
				A2(
					$elm$parser$Parser$Advanced$Token,
					'[',
					$author$project$MDInline$Expecting('Expecting \'[\' to continue extension element'))))),
	A2(
		$elm$parser$Parser$Advanced$ignorer,
		A2(
			$elm$parser$Parser$Advanced$ignorer,
			...
			$elm$parser$Parser$Advanced$symbol(
				A2(
					$elm$parser$Parser$Advanced$Token,
					']',
					$author$project$MDInline$Expecting('Expecting \']\' to end extension element')))),
		$elm$parser$Parser$Advanced$spaces));
...
var $author$project$BlockType$cssLang = A2(
	...
	$elm$parser$Parser$Advanced$symbol(
		A2(
			$elm$parser$Parser$Advanced$Token,
			'css',
			$author$project$BlockType$Expecting('Expecting string for language, use ```nolang if language is unknown or unsupported'))));
...
var $author$project$BlockType$jsonLang = A2(
	...
	$elm$parser$Parser$Advanced$symbol(
		A2(
			...
			'json',
			$author$project$BlockType$Expecting('Expecting string for language, use ```nolang if language is unknown or unsupported'))));
var $author$project$BlockType$NoLang = {$: 'NoLang'};
var $author$project$BlockType$noLang = A2(
	$elm$parser$Parser$Advanced$ignorer,
	$elm$parser$Parser$Advanced$succeed($author$project$BlockType$NoLang),
	$elm$parser$Parser$Advanced$symbol(
		A2(
			$elm$parser$Parser$Advanced$Token,
			'nolang',
...
var $author$project$MDInline$string = function (mmInline) {
	switch (mmInline.$) {
		...
		case 'HtmlEntities':
			return 'HtmlEntity [' + ('Unimplemented HtmlEntities' + ']');
		case 'BracketedText':
			var str = mmInline.a;
...
var $author$project$MDInline$string2 = function (mmInline) {
	switch (mmInline.$) {
		...
		case 'HtmlEntity':
			...
			return str;
		case 'HtmlEntities':
			return 'HtmlEntities: unimplemented';
		case 'BracketedText':
			var str = mmInline.a;
			return str;
		case 'Link':
...
var $author$project$Markdown$Parse$incrementVersion = F2(
	function (id, tree) {
		var inc = F2(
			function (_v0, block) {
				var id_ = _v0.a;
				...
				var lev = block.c;
				var bcont = block.d;
				return _Utils_eq(id_, id__) ? A4(
					$author$project$Markdown$Parse$MDBlockWithId,
					_Utils_Tuple2(id__, v_ + 1),
					bt,
					lev,
					bcont) : block;
			});
...
var $author$project$Main$syncAndHighlightRenderedText = F3(
	function (str, cmd, model) {
		var targetId = A2(
			$elm$core$Maybe$withDefault,
			_Utils_Tuple2(0, 0),
			A2($author$project$Markdown$Parse$searchAST, str, model.lastAst));
		var newAst = A2($author$project$Markdown$Parse$incrementVersion, targetId, model.lastAst);
		var _v0 = targetId;
		var i = _v0.a;
		var v = _v0.b;
		var newId = _Utils_Tuple2(i, v + 1);
		var newIdString = $author$project$Markdown$Parse$stringFromId(newId);
		var renderedText = A3(
			$author$project$Markdown$Render$fromASTWithOptions,
			$author$project$Markdown$Option$ExternalTOC('Contents'),
			newId,
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{lastAst: newAst, renderedText: renderedText, selectedId: newId}),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						cmd,
						$author$project$Main$setViewportForElement(newIdString)
					])));
	});
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$float)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Editor.EditorMsg":{"args":[],"type":"Editor.Update.Msg"},"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"Browser.Dom.Viewport":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"Markdown.Render.DocumentParts":{"args":[],"type":"{ title : Html.Html Markdown.Render.MarkdownMsg, toc : Html.Html Markdown.Render.MarkdownMsg, document : Html.Html Markdown.Render.MarkdownMsg }"},"Html.Html":{"args":["msg"],"type":"VirtualDom.Node msg"},"Markdown.Parse.Id":{"args":[],"type":"( Basics.Int, Basics.Int )"},"Markdown.Parse.Level":{"args":[],"type":"Basics.Int"},"Position.Position":{"args":[],"type":"{ line : Basics.Int, column : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"EditorMsg":["Editor.EditorMsg"],"Outside":["Outside.InfoForElm"],"LogErr":["String.String"],"Clear":[],"Restart":[],"GetContent":["String.String"],"ProcessLine":["String.String"],"SetViewPortForElement":["Result.Result Browser.Dom.Error ( Browser.Dom.Element, Browser.Dom.Viewport )"],"GenerateSeed":[],"NewSeed":["Basics.Int"],"LoadExample1":[],"LoadExample2":[],"SelectStandard":[],"SelectExtended":[],"SelectExtendedMath":[],"GotSecondPart":["( Tree.Tree Markdown.Parse.MDBlockWithId, Markdown.Render.MarkdownOutput )"],"MarkdownMsg":["Markdown.Render.MarkdownMsg"]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Outside.InfoForElm":{"args":[],"tags":{"GotClipboard":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Markdown.Parse.MDBlockWithId":{"args":[],"tags":{"MDBlockWithId":["Markdown.Parse.Id","BlockType.BlockType","Markdown.Parse.Level","Markdown.Parse.BlockContent"]}},"Markdown.Render.MarkdownMsg":{"args":[],"tags":{"IDClicked":["String.String"]}},"Markdown.Render.MarkdownOutput":{"args":[],"tags":{"Simple":["Html.Html Markdown.Render.MarkdownMsg"],"Composite":["Markdown.Render.DocumentParts"]}},"Editor.Update.Msg":{"args":[],"tags":{"NoOp":[],"MouseDown":["Position.Position"],"MouseOver":["Position.Position"],"MouseUp":[],"Copy":[],"CopyPasteClipboard":[],"WriteToSystemClipBoard":[],"Cut":[],"CursorLeft":[],"CursorRight":[],"CursorUp":[],"CursorDown":[],"CursorToLineEnd":[],"CursorToLineStart":[],"CursorToGroupEnd":[],"CursorToGroupStart":[],"Insert":["String.String"],"FirstLine":[],"AcceptLineNumber":["String.String"],"AcceptSearchText":["String.String"],"AcceptReplacementText":["String.String"],"ReplaceCurrentSelection":[],"LastLine":[],"Paste":[],"PasteFromClipboard":[],"RemoveCharAfter":[],"RemoveCharBefore":[],"RemoveGroupAfter":[],"RemoveGroupBefore":[],"Indent":[],"Deindent":[],"SelectUp":[],"SelectDown":[],"SelectLeft":[],"SelectRight":[],"SelectToLineStart":[],"SelectToLineEnd":[],"SelectToGroupStart":[],"SelectToGroupEnd":[],"SelectAll":[],"SelectGroup":[],"SelectLine":[],"SendLine":[],"Undo":[],"Redo":[],"ScrollUp":["Basics.Int"],"ScrollDown":["Basics.Int"],"ScrollToSelection":["( Position.Position, Position.Position )"],"RollSearchSelectionForward":[],"RollSearchSelectionBackward":[],"SyncToSearchHit":[],"Clear":[],"WrapSelection":[],"WrapAll":[],"ToggleWrapping":[],"ToggleHelp":[],"ToggleInfoPanel":[],"ToggleGoToLinePanel":[],"ToggleSearchPanel":[],"ToggleReplacePanel":[],"OpenReplaceField":[],"DebounceMsg":["Debounce.Msg"],"Unload":["String.String"],"GotViewport":["Result.Result Browser.Dom.Error Browser.Dom.Viewport"],"GotViewportForSync":["Position.Position","Maybe.Maybe Position.Position","Result.Result Browser.Dom.Error Browser.Dom.Viewport"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Tree.Tree":{"args":["a"],"tags":{"Tree":["a","List.List (Tree.Tree a)"]}},"Markdown.Parse.BlockContent":{"args":[],"tags":{"M":["MDInline.MDInline"],"T":["String.String"]}},"BlockType.BlockType":{"args":[],"tags":{"BalancedBlock":["BlockType.BalancedType"],"MarkdownBlock":["BlockType.MarkdownType"]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Debounce.Msg":{"args":[],"tags":{"NoOp":[],"Flush":["Maybe.Maybe Basics.Float"],"SendIfLengthNotChangedFrom":["Basics.Int"]}},"VirtualDom.Node":{"args":["msg"],"tags":{"Node":[]}},"BlockType.BalancedType":{"args":[],"tags":{"DisplayCode":["BlockType.Language"],"Verbatim":[],"DisplayMath":[]}},"MDInline.MDInline":{"args":[],"tags":{"OrdinaryText":["String.String"],"ItalicText":["String.String"],"BoldText":["String.String"],"Code":["String.String"],"InlineMath":["String.String"],"StrikeThroughText":["String.String"],"BracketedText":["String.String"],"HtmlEntity":["String.String"],"HtmlEntities":["List.List MDInline.MDInline"],"ExtensionInline":["String.String","String.String"],"Link":["String.String","String.String"],"Image":["String.String","String.String"],"Line":["List.List MDInline.MDInline"],"Paragraph":["List.List MDInline.MDInline"],"Stanza":["String.String"],"Error":["List.List MDInline.MDInline"]}},"BlockType.MarkdownType":{"args":[],"tags":{"Root":[],"UListItem":[],"OListItem":["Basics.Int"],"Heading":["Basics.Int"],"HorizontalRule":[],"Quotation":[],"ExtensionBlock":["String.String"],"Poetry":[],"Plain":[],"Image":[],"Blank":[],"TableCell":[],"TableRow":[],"Table":[]}},"BlockType.Language":{"args":[],"tags":{"ElmLang":[],"CssLang":[],"JavascriptLang":[],"JsonLang":[],"PythonLang":[],"SqlLang":[],"XmlLang":[],"NoLang":[]}}}}})}});}(this));