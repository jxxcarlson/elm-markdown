...
{
	if (region.aR.ag === region.a0.ag)
	{
		return 'on line ' + region.aR.ag;
	}
	return 'on lines ' + region.aR.ag + ' through ' + region.a0.ag;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b6: 'hidden', bU: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b6: 'mozHidden', bU: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b6: 'msHidden', bU: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b6: 'webkitHidden', bU: 'webkitvisibilitychange' }
		: { b6: 'hidden', bU: 'visibilitychange' };
}
...
{
	var flags = 'g';
	if (options.cg) { flags += 'm'; }
	if (options.bT) { flags += 'i'; }
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a4: fragment, a7: host, bi: path, bk: port_, bo: protocol, bp: query};
	});
...
var $author$project$Strings$mathExampleText = '\nddd\n\n';
		...
		switch (msg.$) {
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{v: model.v + 1, L: $author$project$Strings$initialText}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{v: model.v + 1, L: $author$project$Strings$mathExampleText}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$masterId = $elm$html$Html$Attributes$id('__RENDERED_TEXT__');
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$mathText = function (content) {
	return A3(
		$elm$html$Html$node,
		'math-text',
		_List_fromArray(
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$displayMathText = function (str) {
	var str2 = $elm$core$String$trim(str);
	return $jxxcarlson$elm_markdown$Markdown$ElmWithId$mathText('$$\n' + (str2 + '\n$$'));
};
var $elm$core$Tuple$second = function (_v0) {
	var y = _v0.b;
	return y;
};
var $jxxcarlson$elm_markdown$Markdown$Parse$stringOfId = function (id) {
	return '[' + ($elm$core$String$fromInt(id.a) + (', ' + ($elm$core$String$fromInt(id.b) + ']')));
};
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$idAttr = function (id) {
	return $elm$html$Html$Attributes$id(
		$jxxcarlson$elm_markdown$Markdown$Parse$stringOfId(id));
};
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$blockLevelClass = function (k) {
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$marginOfLevel = function (level) {
	return A2(
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor = function (background) {
	return {ac: background, W: false, X: false, ae: false, aI: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$DefaultColor};
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$noEmphasis = F2(
	function (text, background) {
		return {ac: background, W: false, X: false, ae: false, aI: text};
	});
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor = function (text) {
	return {ac: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$DefaultColor, W: false, X: false, ae: false, aI: text};
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$requiredStyles = {
	bM: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#003800')),
	bV: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
	...
	bZ: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#380000')),
	b7: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#343434')),
	cv: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#ae81ff')),
	cw: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#e6db74')),
	cx: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#f92672')),
	cy: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#66d9ef')),
	cz: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#a6e22e')),
	cA: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
		$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$Hex('#ae81ff')),
	cB: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$theme = {
	...
	co: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$requiredStyles
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$styleToCss = function (_v0) {
	var isBold = _v0.W;
	var isItalic = _v0.X;
	var isUnderline = _v0.ae;
	var text = _v0.aI;
	var background = _v0.ac;
	return $elm$core$String$concat(
		_List_fromArray(
			[
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Type$toCss = function (_v0) {
	var requiredStyles = _v0.co;
	var customStyles = _v0.bX;
	return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$toCss(
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2('.elmsh', requiredStyles.bY),
					_Utils_Tuple2('.elmsh-hl', requiredStyles.b7),
					_Utils_Tuple2('.elmsh-add', requiredStyles.bM),
					_Utils_Tuple2('.elmsh-del', requiredStyles.bZ),
					_Utils_Tuple2('.elmsh-comm', requiredStyles.bV),
					_Utils_Tuple2('.elmsh1', requiredStyles.cv),
					_Utils_Tuple2('.elmsh2', requiredStyles.cw),
					_Utils_Tuple2('.elmsh3', requiredStyles.cx),
					_Utils_Tuple2('.elmsh4', requiredStyles.cy),
					_Utils_Tuple2('.elmsh5', requiredStyles.cz),
					_Utils_Tuple2('.elmsh6', requiredStyles.cA),
					_Utils_Tuple2('.elmsh7', requiredStyles.cB)
				]),
			A2(
				$elm$core$List$map,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aW: col, bl: problem, bv: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bv, p.aW, p.bl);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aW: 1, d: _List_Nil, e: 1, b: 0, bv: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$newLine = function (fragments) {
	return {b3: fragments, b7: $elm$core$Maybe$Nothing};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$toFragment = F2(
	function (toStyle, _v0) {
		...
		switch (syntax.$) {
			case 0:
				return {bN: '', cn: 0, aI: text};
			case 1:
				return {bN: '', cn: 1, aI: text};
			case 2:
				return {bN: '', cn: 0, aI: text};
			default:
				var c = syntax.a;
				...
				return {bN: additionalClass, cn: requiredStyle, aI: text};
		}
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aW: col, bW: contextStack, bl: problem, bv: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bv, s.aW, x, s.d));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aW: 1, d: s.d, e: s.e, b: s.b + 1, bv: s.bv + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aW: s.aW + 1, d: s.d, e: s.e, b: newOffset, bv: s.bv, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aW: col, d: s0.d, e: s0.e, b: offset, bv: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bv, s.aW, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bv, s.aW, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aW: newCol, d: s.d, e: s.e, b: newOffset, bv: newRow, a: s.a});
	};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimitedUnnestable = F2(
	function (options, revAList) {
		var defaultMap = options.a_;
		var isNotRelevant = options.bc;
		var end = options.a0;
		var innerParsers = options.a9;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimitedHelp = F2(
	function (options, revAList) {
		...
		var _v0 = _Utils_Tuple2(
			$elm$core$String$uncons(options.aR),
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.bv, s.aW, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Sql$multilineComment = $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimited(
	{
		...
		bb: false,
		bc: A2($elm$core$Basics$composeL, $elm$core$Basics$not, $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$isLineBreak),
		aR: '/*'
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {b9: index, ce: match, ci: number, cC: submatches};
	});
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$xml = A2(
	...
	$elm$core$Result$map($elm$core$Basics$identity));
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$parserOfLanguage = function (lang_) {
	switch (lang_) {
		case 0:
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$idAttrWithLabel = F2(
	function (id, label) {
		return $elm$html$Html$Attributes$id(
			_Utils_ap(
				$jxxcarlson$elm_markdown$Markdown$Parse$stringOfId(id),
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$inlineMathText = F2(
	function (id, str) {
		return A3(
			...
			_List_fromArray(
				[
					A2($jxxcarlson$elm_markdown$Markdown$ElmWithId$idAttrWithLabel, id, 'm')
				]),
			_List_fromArray(
				[
					_Utils_Tuple2(
					$jxxcarlson$elm_markdown$Markdown$Parse$stringOfId(id) + 'm',
					$jxxcarlson$elm_markdown$Markdown$ElmWithId$mathText(
						'$ ' + ($elm$core$String$trim(str) + ' $ ')))
				]));
	});
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderStanza = F2(
	function (id, arg) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$jxxcarlson$elm_markdown$Markdown$ElmWithId$idAttr(id),
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$strikethrough = function (str) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$joinLine = F3(
	function (id, level, items) {
		var folder = F2(
			function (item, _v6) {
				var accString = _v6.a;
				...
				if (!item.$) {
					...
					if (!_Utils_eq(accString, _List_Nil)) {
						...
						return _Utils_Tuple2(
							...
							A2(
								$elm$core$List$cons,
								A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderToHtmlMsg, id, level, item),
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderToHtmlMsg = F3(
	function (id, level, mmInline) {
		switch (mmInline.$) {
			case 0:
				var str = mmInline.a;
				return A2(
					...
					_List_fromArray(
						[
							...
							$jxxcarlson$elm_markdown$Markdown$ElmWithId$marginOfLevel(level)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(str)
			...
			case 4:
				var str = mmInline.a;
				return A2($jxxcarlson$elm_markdown$Markdown$ElmWithId$inlineMathText, id, str);
			case 5:
				var str = mmInline.a;
				return $jxxcarlson$elm_markdown$Markdown$ElmWithId$strikethrough(str);
			case 6:
				var str = mmInline.a;
				return A2(
					$elm$html$Html$span,
			...
			case 9:
				var arg = mmInline.a;
				var joined = A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$joinLine, id, level, arg);
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$jxxcarlson$elm_markdown$Markdown$ElmWithId$blockLevelClass(level - 1)
						]),
					A2(
						$elm$core$List$map,
						A2($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderToHtmlMsg, id, level),
						arg));
			case 11:
				var arg = mmInline.a;
				return A2($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderStanza, id, arg);
			default:
				var arg = mmInline.a;
				return A2(
					$elm$html$Html$p,
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderBlockContent = F3(
	function (id, level, blockContent) {
		if (!blockContent.$) {
			var mmInline = blockContent.a;
			return A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderToHtmlMsg, id, level, mmInline);
		} else {
			var str = blockContent.a;
			return A2(
				$elm$html$Html$span,
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$nameFromBlockContent = function (blockContent) {
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderHeading = F4(
	function (id, k, level, blockContent) {
		var name = $jxxcarlson$elm_markdown$Markdown$ElmWithId$nameFromBlockContent(blockContent);
		switch (k) {
			case 1:
				return A2(
					$elm$html$Html$h1,
					...
					_List_fromArray(
						[
							A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderBlockContent, id, level, blockContent)
						]));
			case 2:
				return A2(
					$elm$html$Html$h2,
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$alphabet = function (k) {
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$prependToParagraph = F2(
	function (head, tail) {
		if (tail.$ === 1) {
			return tail;
		} else {
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$romanNumeral = function (k) {
	var alpha = _List_fromArray(
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderOListItem = F4(
	function (id, index, level, blockContent) {
		var label = function () {
			switch (level) {
				case 1:
					return $elm$core$String$fromInt(index) + '. ';
				case 2:
					return $jxxcarlson$elm_markdown$Markdown$ElmWithId$alphabet(index) + '. ';
				case 3:
					return $jxxcarlson$elm_markdown$Markdown$ElmWithId$romanNumeral(index) + '. ';
				case 4:
					return $elm$core$String$fromInt(index) + '. ';
				default:
					return 'N. ';
		...
		return A2(
			...
			_List_fromArray(
				[
					A3(
					$jxxcarlson$elm_markdown$Markdown$ElmWithId$renderBlockContent,
					id,
					level,
					A2(
						$jxxcarlson$elm_markdown$Markdown$ElmWithId$prependToParagraph,
						$jxxcarlson$elm_markdown$MDInline$OrdinaryText(label),
						blockContent))
				]));
	});
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderPoetry = F3(
	function (id, level, blockContent) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderQuotation = F3(
	function (id, level, blockContent) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					$jxxcarlson$elm_markdown$Markdown$ElmWithId$blockLevelClass(level)
				]),
			_List_fromArray(
				[
					A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderBlockContent, id, level, blockContent)
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderUListItem = F3(
	function (id, level, blockContent) {
		var label = function () {
			switch (level) {
				case 1:
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$View$fragmentView = function (_v0) {
	var text = _v0.aI;
	var requiredStyle = _v0.cn;
	var additionalClass = _v0.bN;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$View$lineView = F3(
	function (start, index, _v0) {
		var fragments = _v0.b3;
		var highlight = _v0.b7;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderBlock = F2(
	function (id, block) {
		if (!block.a.$) {
			switch (block.a.a.$) {
				case 2:
					...
					if (blockContent.$ === 1) {
						...
						return A2(
							...
							_List_fromArray(
								[
									$jxxcarlson$elm_markdown$Markdown$ElmWithId$displayMathText(str)
								]));
					} else {
						return $jxxcarlson$elm_markdown$Markdown$ElmWithId$displayMathText('');
					}
				case 1:
					var _v11 = block.a.a;
					var level = block.b;
								...
								[
									...
									A2(
										...
										$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$toBlockHtml(
											$elm$core$Maybe$Just(1)),
										A2(
											$jxxcarlson$elm_markdown$Markdown$ElmWithId$parserOfLanguage,
											lang,
			...
			switch (block.a.a.$) {
				...
				case 7:
					...
					var level = block.b;
					var blockContent = block.c;
					return A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderBlockContent, id, level, blockContent);
				case 9:
					var _v3 = block.a.a;
					var level = block.b;
					var blockContent = block.c;
				...
				case 3:
					...
					var level = block.b;
					var blockContent = block.c;
					return A4($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderHeading, id, k, level, blockContent);
				case 5:
					var _v4 = block.a.a;
					var level = block.b;
					var blockContent = block.c;
					return A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderQuotation, id, level, blockContent);
				case 6:
					var _v5 = block.a.a;
					var level = block.b;
					var blockContent = block.c;
					return A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderPoetry, id, level, blockContent);
				case 1:
					var _v6 = block.a.a;
					var level = block.b;
					var blockContent = block.c;
					return A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderUListItem, id, level, blockContent);
				case 2:
					var index = block.a.a.a;
					var level = block.b;
					var blockContent = block.c;
					return A4($jxxcarlson$elm_markdown$Markdown$ElmWithId$renderOListItem, id, index, level, blockContent);
				case 4:
					var _v7 = block.a.a;
					var level = block.b;
					var blockContent = block.c;
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$mmBlockTreeToHtml = function (tree) {
	if (_Utils_eq(
			...
			return A3(
				...
				_List_fromArray(
					[
						...
						$jxxcarlson$elm_markdown$Markdown$Parse$stringOfId(id),
						A2(
							$jxxcarlson$elm_markdown$Markdown$ElmWithId$renderBlock,
							id,
			...
			switch (_v3.b.a.$) {
				case 11:
					...
					return A2(
						...
						A2(
							$elm$core$List$map,
							$jxxcarlson$elm_markdown$Markdown$ElmWithId$mmBlockTreeToHtml,
							$zwilias$elm_rosetree$Tree$children(tree)));
				case 12:
					var id = _v3.a;
					var _v5 = _v3.b.a;
					...
					return A3(
						...
						_List_fromArray(
							[
								_Utils_Tuple2(
								$jxxcarlson$elm_markdown$Markdown$Parse$stringOfId(id),
								$jxxcarlson$elm_markdown$Markdown$ElmWithId$displayMathText(
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderHtml = function (blockTreeWithId) {
	return function (x) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[$jxxcarlson$elm_markdown$Markdown$ElmWithId$masterId]),
			x);
	}(
		A2(
			$elm$core$List$map,
		...
		while (true) {
			...
			if (!_v0.b) {
				...
				if (!_v0.a.b.b) {
					...
					var $temp$f = f,
						$temp$state = state_,
						$temp$acc = {c: _List_Nil, cc: label_, j: cs},
						$temp$stack = A2(
						$elm$core$List$cons,
						_Utils_update(
							acc,
...
var $jxxcarlson$elm_markdown$MDInline$image = A2(
	$elm$parser$Parser$Advanced$map,
	function (ps) {
		return A2($jxxcarlson$elm_markdown$MDInline$Image, ps.aF, ps.aI);
	},
	A2(
...
var $jxxcarlson$elm_markdown$MDInline$linkOrBracket = function (ps) {
	var _v0 = ps.aI;
	if (_v0 === ' ') {
		return $jxxcarlson$elm_markdown$MDInline$BracketedText(ps.aF);
	} else {
		return A2($jxxcarlson$elm_markdown$MDInline$Link, ps.aI, ps.aF);
	}
};
...
var $jxxcarlson$elm_markdown$MDInline$wrapper = F2(
	function (str, acc) {
		return (acc.A === '') ? {A: str, Z: _List_Nil} : ($jxxcarlson$elm_markdown$MDInline$endsWithPunctuation(acc.A) ? {
			A: str,
			Z: A2($elm$core$List$cons, acc.A, acc.Z)
		} : _Utils_update(
			acc,
			{A: acc.A + (' ' + str)}));
	});
var $jxxcarlson$elm_markdown$MDInline$wrap = function (strList) {
	return $elm$core$List$reverse(
		function (acc) {
			return A2($elm$core$List$cons, acc.A, acc.Z);
		}(
			A3(
				$elm$core$List$foldl,
...
var $zwilias$elm_rosetree$Tree$Zipper$fromTree = function (t) {
	return {as: _List_Nil, aK: _List_Nil, o: _List_Nil, f: t};
};
		...
		return $elm$core$Maybe$Just(
			{
				...
				aK: crumb.aK,
				o: rest,
				f: A4($zwilias$elm_rosetree$Tree$Zipper$reconstruct, zipper.f, zipper.aK, zipper.as, crumb.cc)
			});
	}
};
...
var $zwilias$elm_rosetree$Tree$Zipper$lastChild = function (_v0) {
	...
	var _v1 = $elm$core$List$reverse(
		$zwilias$elm_rosetree$Tree$children(zipper.f));
	if (!_v1.b) {
		return $elm$core$Maybe$Nothing;
	} else {
		var c = _v1.a;
		...
		return $elm$core$Maybe$Just(
			{
				...
				o: A2(
					$elm$core$List$cons,
					{
						as: zipper.as,
						aK: zipper.aK,
						cc: $zwilias$elm_rosetree$Tree$label(zipper.f)
					},
					zipper.o),
				f: c
			});
...
var $zwilias$elm_rosetree$Tree$Zipper$previousSibling = function (_v0) {
	...
	if (!_v1.b) {
		...
		return $elm$core$Maybe$Just(
			{
				as: A2($elm$core$List$cons, zipper.f, zipper.as),
				aK: rest,
				o: zipper.o,
				f: previous
			});
...
var $jxxcarlson$elm_markdown$Markdown$Parse$topOfBlockStack = function (register) {
	return $elm$core$List$head(register.n);
};
		...
		if (((!_v1.$) && (_v1.a.$ === 1)) && (_v1.a.a.$ === 11)) {
			...
			var tableData = A2(
				...
				function (x) {
					...
					$elm$core$List$reverse(register.n)));
			var newBlocks = A2(
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.bv, s.aW, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $jxxcarlson$elm_markdown$Markdown$Parse$processBalancedBlock = F3(
	function (blockType, line, fsm) {
		...
		if (_Utils_eq(
			...
			var _v1 = $jxxcarlson$elm_markdown$Markdown$Parse$stateOfFSM(fsm);
			if (_v1.$ === 1) {
				var block_ = _v1.a;
				...
				return A3(
					...
					_Utils_update(
						register,
						{
							N: A2($elm$core$List$drop, 1, register.N)
						}));
			} else {
				return fsm;
			}
	...
	function (line, _v0) {
		...
		switch (state_.$) {
			...
			case 2:
				return A3($jxxcarlson$elm_markdown$Markdown$Parse$FSM, state_, blocks_, register);
			default:
				var _v2 = $elm$core$List$head(register.n);
				if (_v2.$ === 1) {
					return A3(
						$jxxcarlson$elm_markdown$Markdown$Parse$FSM,
		...
		switch (_v0) {
			case 1:
				return _Utils_Tuple2(
					...
					_Utils_update(
						register,
						{af: register.af + 1, Y: 0, R: 0, I: 0}));
			case 2:
				return _Utils_Tuple2(
					register.Y + 1,
					_Utils_update(
						register,
						{Y: register.Y + 1, R: 0, I: 0}));
			case 3:
				return _Utils_Tuple2(
					register.R + 1,
					_Utils_update(
			...
			if ($jxxcarlson$elm_markdown$BlockType$isCode(blockType)) {
				return _Utils_Tuple2(
					...
					_Utils_update(
						register,
						{
							N: A2($elm$core$List$cons, blockType, register.N)
						}));
			} else {
...
var $jxxcarlson$elm_markdown$Markdown$Parse$nextStateStart = F3(
	function (option, line, fsm) {
		var state = fsm.a;
		var blocks = fsm.b;
		var register = fsm.c;
...
var $jxxcarlson$elm_markdown$Markdown$Parse$nextState = F3(
	function (option, line, fsm_) {
		...
		switch (_v0.$) {
			case 0:
				return A3($jxxcarlson$elm_markdown$Markdown$Parse$nextStateStart, option, line, fsm);
			case 1:
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$toHtml = F3(
	function (version, option, str) {
		return $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderHtml(
...
var $jxxcarlson$elm_markdown$Markdown$Elm$toHtml = F2(
	function (option, str) {
		return A3($jxxcarlson$elm_markdown$Markdown$ElmWithId$toHtml, 0, option, str);
	});
	...
	return A3(
		...
		_List_fromArray(
			[
				...
				A2($jxxcarlson$elm_markdown$Markdown$Elm$toHtml, 2, model.L))
			]));
};
var $author$project$Main$RestoreText = {$: 4};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Markdown + Math Demo')
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Edit or write new Markdown + Math below.')
					])),
				$author$project$Main$label(
				'counter: ' + $elm$core$String$fromInt(model.v)),
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{ca: $author$project$Main$init, cD: $author$project$Main$subscriptions, cI: $author$project$Main$update, cK: $author$project$Main$view});
