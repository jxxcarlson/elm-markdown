...
var $author$project$Main$init = function (flags) {
	var model = {counter: 0, seed: 0, sourceText: $author$project$Strings$initialText};
		...
		switch (msg.$) {
			...
			case 'ExampleText':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{counter: model.counter + 1, sourceText: $author$project$Strings$mathExampleText}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$renderHtml = F2(
...
var $jxxcarlson$elm_markdown$Markdown$ElmWithId$toHtml = F4(
	function (selectedId, version, option, str) {
		return A2(
			$jxxcarlson$elm_markdown$Markdown$ElmWithId$renderHtml,
			selectedId,
...
var $jxxcarlson$elm_markdown$Markdown$Elm$toHtml = F2(
	function (option, str) {
		return A4(
			$jxxcarlson$elm_markdown$Markdown$ElmWithId$toHtml,
			_Utils_Tuple2(0, 0),
			0,
			option,
			str);
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($jxxcarlson$elm_markdown$Markdown$Elm$toHtml, $jxxcarlson$elm_markdown$Markdown$Option$ExtendedMath, model.sourceText)))
			]));
};
