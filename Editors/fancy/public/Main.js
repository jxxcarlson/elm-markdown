...
var $author$project$Main$titleView = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$map, $author$project$Main$MarkdownMsg, model.renderedText.title)
			]));
};
...
var $author$project$Main$renderedSource = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$map, $author$project$Main$MarkdownMsg, model.renderedText.document)
			]));
};
var $author$project$Main$tocView = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$map, $author$project$Main$MarkdownMsg, model.renderedText.toc)
			]));
};
